...
var PreviewGroupContext = React4.createContext(null);
...
function useRegisterImage(canPreview, data) {
  ...
  var groupContext = React5.useContext(PreviewGroupContext);
  var registerData = {
    data,
    canPreview
  };
...
var OrderContext = React6.createContext(null);
...
function useDom(render, debug) {
  ...
  var appendedRef = React7.useRef(false);
  var queueCreate = React7.useContext(Context_default2);
  var _React$useState3 = React7.useState(EMPTY_LIST), _React$useState4 = _slicedToArray(_React$useState3, 2), queue = _React$useState4[0], setQueue = _React$useState4[1];
...
var Portal = React9.forwardRef(function(props, ref) {
  ...
  var _React$useState = React9.useState(open), _React$useState2 = _slicedToArray(_React$useState, 2), shouldRender = _React$useState2[0], setShouldRender = _React$useState2[1];
  ...
  var _React$useState3 = React9.useState(function() {
  ...
  if (ref) {
    reffedChildren = React9.cloneElement(children, {
      ref: mergedRef
    });
  }
  return React9.createElement(Context_default2.Provider, {
    value: queueCreate
...
var RefContext = React10.createContext({});
...
function getUseId() {
  var fullClone4 = _objectSpread2({}, React11);
...
function findDOMNode(node2) {
  ...
  if (node2 instanceof import_react2.default.Component) {
    return import_react_dom2.default.findDOMNode(node2);
  }
  return null;
}
...
function MotionProvider(_ref) {
  ...
  return React13.createElement(Context.Provider, {
    value: props
  }, children);
}
...
var useNextFrame_default = function() {
  var nextFrameRef = React16.useRef(null);
...
function useStatus2(supportMotion, visible, getElement, _ref) {
  ...
  var eventHandlers = React18.useMemo(function() {
  ...
  var firstMountChangeRef = React18.useRef(false);
  (0, import_react5.useEffect)(function() {
    if (asyncVisible) {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React19.forwardRef(function(props, ref) {
    var _props$visible = props.visible, visible = _props$visible === void 0 ? true : _props$visible, _props$removeOnLeave = props.removeOnLeave, removeOnLeave = _props$removeOnLeave === void 0 ? true : _props$removeOnLeave, forceRender = props.forceRender, children = props.children, motionName = props.motionName, leavedClassName = props.leavedClassName, eventProps = props.eventProps;
    var _React$useContext = React19.useContext(Context), contextMotion = _React$useContext.motion;
    ...
    var _useStatus = useStatus2(supportMotion, visible, getDomElement, props), _useStatus2 = _slicedToArray(_useStatus, 4), status = _useStatus2[0], statusStep = _useStatus2[1], statusStyle = _useStatus2[2], mergedVisible = _useStatus2[3];
    var renderedRef = React19.useRef(mergedVisible);
    if (mergedVisible) {
      renderedRef.current = true;
    }
    var setNodeRef = React19.useCallback(function(node2) {
    ...
    if (React19.isValidElement(motionChildren) && supportRef(motionChildren)) {
      var _ref = motionChildren, originNodeRef = _ref.ref;
      if (!originNodeRef) {
        motionChildren = React19.cloneElement(motionChildren, {
          ref: setNodeRef
        });
      }
    }
    return React19.createElement(DomWrapper_default, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component3 = component || React20.Fragment;
        var motionProps = {};
        ...
        return React20.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
          var status = _ref2.status, eventProps = _objectWithoutProperties(_ref2, _excluded22);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return React20.createElement(CSSMotion, _extends({}, motionProps, {
            key: eventProps.key,
            visible,
            eventProps,
...
var MemoChildren_default = React21.memo(function(_ref) {
...
var Panel = import_react7.default.forwardRef(function(props, ref) {
  ...
  var _React$useContext = import_react7.default.useContext(RefContext), panelRef = _React$useContext.panel;
  var mergedRef = useComposeRef(holderRef, panelRef);
  var sentinelStartRef = (0, import_react7.useRef)();
  var sentinelEndRef = (0, import_react7.useRef)();
  ...
  var footerNode;
  if (footer) {
    footerNode = import_react7.default.createElement("div", {
  ...
  var headerNode;
  if (title) {
    headerNode = import_react7.default.createElement("div", {
  ...
  var closer;
  if (closable) {
    closer = import_react7.default.createElement("button", {
      type: "button",
      onClick: onClose,
      "aria-label": "Close",
      className: "".concat(prefixCls, "-close")
    }, closeIcon || import_react7.default.createElement("span", {
      className: "".concat(prefixCls, "-close-x")
    }));
  }
  var content = import_react7.default.createElement("div", {
  ...
  }, closer, headerNode, import_react7.default.createElement("div", _extends({
  ...
  return import_react7.default.createElement("div", {
    ...
    style: sentinelStyle,
    "aria-hidden": "true"
  }), import_react7.default.createElement(MemoChildren_default, {
    shouldUpdate: visible || forceRender
  }, modalRender ? modalRender(content) : content), import_react7.default.createElement("div", {
    tabIndex: 0,
    ref: sentinelEndRef,
    style: sentinelStyle,
    "aria-hidden": "true"
...
// node_modules/rc-dialog/es/Dialog/Content/index.js
var Content = React23.forwardRef(function(props, ref) {
  ...
  var dialogRef = (0, import_react8.useRef)();
  var _React$useState = React23.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), transformOrigin = _React$useState2[0], setTransformOrigin = _React$useState2[1];
  var contentStyle = {};
  if (transformOrigin) {
  ...
  return React23.createElement(es_default2, {
    ...
    return React23.createElement(Panel_default, _extends({}, props, {
      ref,
      title,
      ariaId,
      prefixCls,
...
function Mask(props) {
  ...
  return React24.createElement(es_default2, {
    key: "mask",
    visible,
    motionName,
...
function Dialog(props) {
  ...
  var lastOutSideActiveElementRef = (0, import_react9.useRef)();
  var wrapperRef = (0, import_react9.useRef)();
  var contentRef = (0, import_react9.useRef)();
  ...
  var contentClickRef = (0, import_react9.useRef)(false);
  var contentTimeoutRef = (0, import_react9.useRef)();
  ...
  }), React25.createElement("div", _extends({
    tabIndex: -1,
  ...
  }, wrapProps), React25.createElement(Content_default, _extends({}, props, {
...
var DialogWrap = function DialogWrap2(props) {
  ...
  var _React$useState = React26.useState(visible), _React$useState2 = _slicedToArray(_React$useState, 2), animatedVisible = _React$useState2[0], setAnimatedVisible = _React$useState2[1];
  var refContext = React26.useMemo(function() {
    return {
      panel: panelRef
    };
  }, [panelRef]);
  ...
  return React26.createElement(RefContext.Provider, {
    value: refContext
  ...
  }, React26.createElement(Dialog, _extends({}, props, {
    destroyOnClose,
...
function useTouchEvent(imgRef, movable, visible, minScale, transform, updateTransform, dispatchZoomChange) {
  var rotate = transform.rotate, scale = transform.scale, x = transform.x, y = transform.y;
  var _useState = (0, import_react12.useState)(false), _useState2 = _slicedToArray(_useState, 2), isTouching = _useState2[0], setIsTouching = _useState2[1];
  var touchPointInfo = (0, import_react12.useRef)({
    point1: {
      x: 0,
      y: 0
    },
...
var Operations = function Operations2(props) {
  ...
  var groupContext = (0, import_react13.useContext)(PreviewGroupContext);
...
var _excluded23 = ["prefixCls", "src", "alt", "fallback", "movable", "onClose", "visible", "icons", "rootClassName", "closeIcon", "getContainer", "current", "count", "countRender", "scaleStep", "minScale", "maxScale", "transitionName", "maskTransitionName", "imageRender", "imgCommonProps", "toolbarRender", "onTransform", "onChange"];
...
var Group = function Group2(_ref) {
  ...
  var _usePreviewItems = usePreviewItems(items), _usePreviewItems2 = _slicedToArray(_usePreviewItems, 2), mergedItems = _usePreviewItems2[0], register = _usePreviewItems2[1];
  ...
  var onPreviewFromImage = React30.useCallback(function(id, mouseX, mouseY) {
...
var ImageInternal = function ImageInternal2(props) {
  ...
  return React31.createElement(React31.Fragment, null, React31.createElement("div", _extends({}, otherProps, {
  ...
  }), React31.createElement("img", _extends({}, imgCommonProps, {
    ...
    height,
    onError
  })), status === "loading" && React31.createElement("div", {
    "aria-hidden": "true",
    className: "".concat(prefixCls, "-placeholder")
  }, placeholder), previewMask && canPreview && React31.createElement("div", {
  ...
  }, previewMask)), !groupContext && canPreview && React31.createElement(Preview_default, _extends({
    "aria-hidden": !isShowPreview,
    visible: isShowPreview,
    prefixCls: previewPrefixCls,
    onClose: onPreviewClose,
...
var StyleContext = React32.createContext({
  hashPriority: "low",
  cache: createCache(),
  defaultCache: true
});
...
var fullClone = _objectSpread2({}, React33);
var useInsertionEffect = fullClone.useInsertionEffect;
var useInsertionEffectPolyfill = function useInsertionEffectPolyfill2(renderEffect, effect, deps) {
  React33.useMemo(renderEffect, deps);
  useLayoutEffect_default(function() {
    return effect(true);
  }, deps);
};
...
var fullClone2 = _objectSpread2({}, React34);
...
function useGlobalCache(prefix2, keyPath, cacheFn, onCacheRemove, onCacheEffect) {
  var _React$useContext = React35.useContext(StyleContext_default), globalCache = _React$useContext.cache;
...
function useStyleRegister(info, styleFn) {
  ...
  var _React$useContext = React36.useContext(StyleContext_default), autoClear = _React$useContext.autoClear, mock = _React$useContext.mock, defaultCache = _React$useContext.defaultCache, hashPriority = _React$useContext.hashPriority, container = _React$useContext.container, ssrInline = _React$useContext.ssrInline, transformers = _React$useContext.transformers, linters = _React$useContext.linters, cache = _React$useContext.cache;
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      styleNode = React36.createElement(Empty, null);
    } else {
      var _ref6;
      styleNode = React36.createElement("style", _extends({}, (_ref6 = {}, _defineProperty(_ref6, ATTR_TOKEN, cachedTokenKey), _defineProperty(_ref6, ATTR_MARK, cachedStyleId), _ref6), {
        dangerouslySetInnerHTML: {
          __html: cachedStyleStr
        }
      }));
    }
    return React36.createElement(React36.Fragment, null, styleNode, node2);
  };
}
...
var WarningContext = React41.createContext({});
var devUseWarning = true ? (component) => {
  const {
    strict
  } = React41.useContext(WarningContext);
...
var fullClone3 = Object.assign({}, React48);
var {
  useId: useId2
} = fullClone3;
var useEmptyId = () => "";
...
function MotionWrapper(props) {
  ...
  const needWrapMotionProviderRef = React49.useRef(false);
  needWrapMotionProviderRef.current = needWrapMotionProviderRef.current || motion === false;
  if (needWrapMotionProviderRef.current) {
    return React49.createElement(MotionProvider, {
      motion
    }, children);
  }
  return children;
...
var PropWarning = React50.memo((_ref) => {
  let {
...
var ProviderChildren = (props) => {
  ...
  const getPrefixCls = React51.useCallback((suffixCls, customizePrefixCls) => {
    const {
      prefixCls
    } = props;
    if (customizePrefixCls) {
  ...
  const memoIconContextValue = React51.useMemo(() => ({
    prefixCls: iconPrefixCls,
    csp
  }), [iconPrefixCls, csp]);
  let childNode = React51.createElement(React51.Fragment, null, React51.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  const validateMessages = React51.useMemo(() => {
    var _a, _b, _c, _d;
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React51.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale5) {
    childNode = React51.createElement(locale_default, {
      locale: locale5,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React51.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React51.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React51.createElement(MotionWrapper, null, childNode);
  const memoTheme = React51.useMemo(() => {
  ...
  if (theme) {
    childNode = React51.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (memoedConfig.warning) {
    childNode = React51.createElement(WarningContext.Provider, {
      value: memoedConfig.warning
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React51.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React51.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  const context = React51.useContext(ConfigContext);
  const antLocale = React51.useContext(context_default);
  return React51.createElement(ProviderChildren, Object.assign({
...
var icons = {
  rotateLeft: React52.createElement(RotateLeftOutlined_default, null),
  rotateRight: React52.createElement(RotateRightOutlined_default, null),
  zoomIn: React52.createElement(ZoomInOutlined_default, null),
  zoomOut: React52.createElement(ZoomOutOutlined_default, null),
  close: React52.createElement(CloseOutlined_default, null),
  left: React52.createElement(LeftOutlined_default, null),
  right: React52.createElement(RightOutlined_default, null),
  flipX: React52.createElement(SwapOutlined_default, null),
  flipY: React52.createElement(SwapOutlined_default, {
    rotate: 90
  })
};
var InternalPreviewGroup = (_a) => {
  var {
    ...
    preview
  } = _a, props = __rest4(_a, ["previewPrefixCls", "preview"]);
  const {
    getPrefixCls
  ...
  const mergedPreview = React52.useMemo(() => {
    var _a2;
    if (preview === false) {
      return preview;
    }
  ...
  return wrapCSSVar(React52.createElement(es_default4.PreviewGroup, Object.assign({
...
//# sourceMappingURL=chunk-VPG2CDSP.js.map
